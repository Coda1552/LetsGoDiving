...
import coda.whimsey.registry.LGDEntities;
import coda.whimsey.registry.LGDItems;
...
@Mod(LetsGoDiving.MOD_ID)
public class LetsGoDiving {
    public static final String MOD_ID = "whimsey";
    public static final CreativeModeTab GROUP = new CreativeModeTab(MOD_ID) {
        @Override
        public ItemStack makeIcon() {
            return new ItemStack(LGDItems.PHOENIX_ASHES.get());
        }
    };
    ...
    public LetsGoDiving() {
        ...
        LGDItems.ITEMS.register(bus);
        LGDEntities.ENTITIES.register(bus);
    ...
    private void createAttributes(EntityAttributeCreationEvent e) {
        e.put(LGDEntities.PHOENIX.get(), Phoenix.createAttributes().build());
    }
